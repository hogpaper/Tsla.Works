...
namespace Tsla.Works.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private Microsoft.AspNetCore.Identity.SignInResult AuthenticateTeslaAccount()
        {
        ...
        public static async Task<TeslaOAuthResponse> Authenticate()
        {
        ...
        public static async Task<bool> Wake()
        {
            bool response = false;
            Uri url = new Uri("https://owner-api.teslamotors.com/api/1/vehicles/38295696695776307/wake_up");
            AccountController.client.DefaultRequestHeaders.Remove("Authorization");
            AccountController.client.DefaultRequestHeaders.Add("Authorization", "bearer 5fead6933d5d64047a5cebf51ae6208bfd4f5ae1a16142971ec5c23ff8bc66de");
            AccountController.client.DefaultRequestHeaders.Remove("User-Agent");
            AccountController.client.DefaultRequestHeaders.Add("User-Agent", "tsla.works");
            response = await AccountController.ApiPost(url);
            return response;
        }

        public static async Task<bool> IsAwake()
        {
            bool awake = false;
            Uri url = new Uri("https://owner-api.teslamotors.com/api/1/vehicles/38295696695776307/mobile_enabled");
            AccountController.client.DefaultRequestHeaders.Remove("Authorization");
            AccountController.client.DefaultRequestHeaders.Add("Authorization", "bearer 5fead6933d5d64047a5cebf51ae6208bfd4f5ae1a16142971ec5c23ff8bc66de");
            AccountController.client.DefaultRequestHeaders.Remove("User-Agent");
            AccountController.client.DefaultRequestHeaders.Add("User-Agent", "tsla.works");
            HttpResponseMessage response = await AccountController.client.GetAsync(url);
