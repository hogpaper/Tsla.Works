...
namespace Tsla.Works.Models
{
    ...
    public class Climate_State
    {
        ...
        public int driver_temp_setting { get; set; }
        ...
        public int max_avail_temp { get; set; }
        public int min_avail_temp { get; set; }
        public float outside_temp { get; set; }
        public int passenger_temp_setting { get; set; }
    ...
    public class Charge_State
    {
        ...
        public int scheduled_charging_start_time { get; set; }
        public int time_to_full_charge { get; set; }
        public long timestamp { get; set; }
    ...
    public class Speed_Limit_Mode
    {
        ...
        public int current_limit_mph { get; set; }
